...
public class TornadoDataFrames {
//    // column types for the tornado table
    ...
    public static void main(String[] args) throws Exception {
        ...
        Table tornadoes = Table.createFromCsv("data/tornadoes_1950-2014.csv",true);
//        assert (tornadoes != null);
        System.out.print(tornadoes);
...
//
    out();
    out("Use first(3) to view the first 10 rows:");
    out(tornadoes.first(10).print());
//
    tornadoes = tornadoes.selectWhere(column("Start Lat").isGreaterThan(20f));
        Scatter.show("US Tornadoes 1950-2014", tornadoes.nCol("Start Lon"),
                tornadoes.nCol("Start Lat"));
//
//    out();
